...
// Renders the /api/videos/[videoId] payload; it never touches the database. The three text
// fields below are filled by that route from the video_text side table (see hydrateVideoText
