...
// Load batch 3
const batchData = JSON.parse(fs.readFileSync('docs/comment-batches/batch-03.json', 'utf8'));

console.log(`Batch 3 contains ${batchData.length} comments`);
...
// Save the two parts
fs.writeFileSync(
  'docs/comment-batches-split/batch-03-part1.json',
  JSON.stringify(part1, null, 2)
);

fs.writeFileSync(
  'docs/comment-batches-split/batch-03-part2.json',
