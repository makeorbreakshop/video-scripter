...
// Extract batch 23 (comments 5501-5750)
const batchStart = 5500;
const batchEnd = 5750;
...
// Save both parts
fs.writeFileSync('batch-23-part1.json', JSON.stringify(part1, null, 2));
fs.writeFileSync('batch-23-part2.json', JSON.stringify(part2, null, 2));

console.log(`Batch 23 extracted:`);
