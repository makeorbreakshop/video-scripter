...
// Extract batch 19 (comments 4501-4750)
const batchStart = 4500;
const batchEnd = 4750;
...
// Save both parts
fs.writeFileSync('batch-19-part1.json', JSON.stringify(part1, null, 2));
fs.writeFileSync('batch-19-part2.json', JSON.stringify(part2, null, 2));
