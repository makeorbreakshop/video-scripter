...
// Extract batch 24 (comments 5751-6000)
const batchStart = 5750;
const batchEnd = 6000;
...
// Save both parts
fs.writeFileSync('batch-24-part1.json', JSON.stringify(part1, null, 2));
fs.writeFileSync('batch-24-part2.json', JSON.stringify(part2, null, 2));
