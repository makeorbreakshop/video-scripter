...
// Extract batch 16 (comments 3751-4000)
const batchStart = 3750;
const batchEnd = 4000;
...
// Save both parts
fs.writeFileSync('batch-16-part1.json', JSON.stringify(part1, null, 2));
fs.writeFileSync('batch-16-part2.json', JSON.stringify(part2, null, 2));
