...
// Extract batch 20 (comments 4751-5000)
const batchStart = 4750;
const batchEnd = 5000;
...
// Save both parts
fs.writeFileSync('batch-20-part1.json', JSON.stringify(part1, null, 2));
fs.writeFileSync('batch-20-part2.json', JSON.stringify(part2, null, 2));
