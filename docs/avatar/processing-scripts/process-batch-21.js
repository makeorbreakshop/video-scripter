...
// Extract batch 21 (comments 5001-5250)
const batchStart = 5000;
const batchEnd = 5250;
...
// Save both parts
fs.writeFileSync('batch-21-part1.json', JSON.stringify(part1, null, 2));
fs.writeFileSync('batch-21-part2.json', JSON.stringify(part2, null, 2));
