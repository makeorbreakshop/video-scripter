...
// Extract batch 15 (comments 3501-3750)
const batchStart = 3500;
const batchEnd = 3750;
...
// Save both parts
fs.writeFileSync('batch-15-part1.json', JSON.stringify(part1, null, 2));
fs.writeFileSync('batch-15-part2.json', JSON.stringify(part2, null, 2));

console.log(`Batch 15 extracted:`);
