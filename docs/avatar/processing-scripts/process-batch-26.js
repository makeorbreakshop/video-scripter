...
// Extract batch 26 (comments 6251-6500)
const batchStart = 6250;
const batchEnd = 6500;
...
// Save both parts
fs.writeFileSync('batch-26-part1.json', JSON.stringify(part1, null, 2));
fs.writeFileSync('batch-26-part2.json', JSON.stringify(part2, null, 2));

console.log(`Batch 26 extracted:`);
