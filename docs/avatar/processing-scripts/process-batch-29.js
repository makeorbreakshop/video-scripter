...
// Extract batch 29 (comments 7001-7250)
const batchStart = 7000;
const batchEnd = 7250;
...
// Save both parts
fs.writeFileSync('batch-29-part1.json', JSON.stringify(part1, null, 2));
fs.writeFileSync('batch-29-part2.json', JSON.stringify(part2, null, 2));
