...
// Extract batch 22 (comments 5251-5500)
const batchStart = 5250;
const batchEnd = 5500;
...
// Save both parts
fs.writeFileSync('batch-22-part1.json', JSON.stringify(part1, null, 2));
fs.writeFileSync('batch-22-part2.json', JSON.stringify(part2, null, 2));
