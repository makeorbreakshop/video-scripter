...
// Extract batch 18 (comments 4251-4500)
const batchStart = 4250;
const batchEnd = 4500;
...
// Save both parts
fs.writeFileSync('batch-18-part1.json', JSON.stringify(part1, null, 2));
fs.writeFileSync('batch-18-part2.json', JSON.stringify(part2, null, 2));

console.log(`Batch 18 extracted:`);
