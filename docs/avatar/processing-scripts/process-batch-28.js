...
// Extract batch 28 (comments 6751-7000)
const batchStart = 6750;
const batchEnd = 7000;
...
// Save both parts
fs.writeFileSync('batch-28-part1.json', JSON.stringify(part1, null, 2));
fs.writeFileSync('batch-28-part2.json', JSON.stringify(part2, null, 2));
