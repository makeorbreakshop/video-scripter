 ...
 */
export async function getPatternInsightsTool(params) {
    const { pattern_examples, include_thumbnails = false } = params;
    ...
    try {
        ...
        const topTags = Object.entries(tagFrequency)
            .sort(([, a], [, b]) => b - a)
            .slice(0, 10)
            .map(([tag, count]) => ({ tag, count, percentage: (count / videos.length) * 100 }));
        // Format response
        const response = {
...
//# sourceMappingURL=get-pattern-insights.js.map