...
import {
  ...
  searchOutlierPackagesTool,
} from './tools/search-outlier-packages.js';
      ...
      try {
        switch (name) {
          case 'explore_patterns':
            return await explorePatternsTool(args as any);
          
          case 'find_cross_niche_patterns':
            return await findCrossNichePatternsTool(args as any);
          
          case 'get_pattern_insights':
            return await getPatternInsightsTool(args as any);
