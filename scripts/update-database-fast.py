#!/usr/bin/env python3
"""
Fast parallel update of Supabase database from cached BERTopic classifications
Uses asyncio and concurrent connections for maximum speed
"""
...
MAX_CONCURRENT = 50  # Number of concurrent updates
...
async def main():
    print("="*60)
    print("BERTopic Database Update - Fast Parallel Version")
    print("="*60)
