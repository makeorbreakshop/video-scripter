-- REVERT TO SIMPLE WORKING FUNCTION - Stop overcomplicating things!
...
BEGIN
  ...
  -- SIMPLE QUERY - INCLUDE ALL VIDEOS, USE PRE-CALCULATED BASELINES
  RETURN QUERY EXECUTE format('
    WITH filtered_videos AS (
      SELECT 
        ...
        v.is_competitor,
        v.channel_id,
        v.rolling_baseline_views as channel_avg_views,  -- Show the individual rolling baseline for this video
