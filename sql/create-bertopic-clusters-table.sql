-- Create table for storing BERTopic cluster data
...
-- Add comments
COMMENT ON TABLE bertopic_clusters IS 'BERTopic cluster data for video topic classification';
COMMENT ON COLUMN bertopic_clusters.cluster_id IS 'Unique cluster identifier';
...
COMMENT ON COLUMN bertopic_clusters.centroid_embedding IS 'Centroid embedding vector for the cluster';
COMMENT ON COLUMN bertopic_clusters.video_count IS 'Number of videos in this cluster';