-- Fix type mismatch error in get_packaging_performance function
-- The function was returning ROUND() result as numeric but expected integer
-- Keep the original logic but fix the type casting
